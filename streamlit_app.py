...
with st.sidebar:
  ...
  bill_depth_mm = st.slider('bill depth (mm)', 13.0, 21.5, 17.2)
...
st.dataframe(df_prediction_proba,
             column_config={
               'Adelie': st.column_config.progressColmn(
                 'Adelie',
                 format='%f',
                 width='medium',
                 min_value=0,
                ...
                'Chinstrap': st.column_config.progressColmn(
                 'Chinstrap',
                 format='%f',
                 width='medium',
                 min_value=0,
                ...
                'Gentoo': st.column_config.progressColmn(
                 'Gentoo',
                 format='%f',
                 width='medium',
                 min_value=0,
